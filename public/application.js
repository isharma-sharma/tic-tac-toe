...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).then(ui.signInSuccess).then(api.getGamesForUser).then(ui.getGameSuccess).catch(ui.signInFailure).catch(ui.getGameFailure);
	};
	...
	var onGetGamesForUser = function onGetGamesForUser(event) {
	  event.preventDefault();
	  // const data = getFormFields(event.target)
	  api.getGamesForUser().then(ui.getGameSuccess).catch(ui.getGameFailure);
	};
	var onShowGamesForUser = function onShowGamesForUser(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var winner = function winner() {
	  ...
	  } else if (store.gameArray[0] + store.gameArray[4] + store.gameArray[8] === 'xxx' || store.gameArray[3] + store.gameArray[4] + store.gameArray[5] === 'xxx' || store.gameArray[6] + store.gameArray[4] + store.gameArray[2] === 'xxx' || store.gameArray[1] + store.gameArray[4] + store.gameArray[7] === 'xxx') {
	  ...
	  } else if (store.gameArray[0] + store.gameArray[1] + store.gameArray[2] === 'ooo' || store.gameArray[2] + store.gameArray[5] + store.gameArray[8] === 'ooo' || store.gameArray[3] + store.gameArray[4] + store.gameArray[5] === 'ooo' || store.gameArray[6] + store.gameArray[7] + store.gameArray[8] === 'ooo') {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "79b581000e7f50199635fa5841f87241.png";
